...
export default function FunctionList({ functions, onSelectFunction }: FunctionListProps) {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="bg-gradient-to-br from-red-500 to-orange-500 text-white py-20">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                    ...
                    >
                      ...
                      <div className="bg-red-50 px-8 py-4">
                        <div className="flex items-center text-sm">
                          ...
                          <span className="font-bold text-red-700">{func.pricing.split('(')[0]}</span>
                        </div>
                      </div>
                    </div>
                  );
        ...
        <section className="mt-16 bg-gradient-to-br from-red-500 to-orange-500 rounded-2xl p-12 text-white text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button className="bg-white text-red-600 px-8 py-4 rounded-lg hover:bg-red-50 transition-colors font-semibold">
              Schedule Free Consultation
            </button>
            <button className="border-2 border-white text-white px-8 py-4 rounded-lg hover:bg-red-600 transition-colors font-semibold">
              Contact Us
            </button>
          </div>
        </section>
