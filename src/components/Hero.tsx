...
export default function Hero({ onNavigateToDocumentation, onNavigateToFunctions }: HeroProps) {
  return (
    <section id="home" className="pt-20 pb-24 bg-gradient-to-br from-red-50 via-white to-orange-50 relative overflow-hidden">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div>
            <h1 className="text-5xl md:text-6xl font-bold leading-tight mb-6">
              <span className="text-red-500">Compliance</span>
              <br />
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-12">
              <button
                ...
                className="bg-red-500 text-white px-8 py-4 rounded-full hover:bg-red-600 transition-all transform hover:scale-105 flex items-center justify-center group shadow-lg"
              >
                Explore Services
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
              <div>
                <div className="text-4xl font-bold text-red-500 mb-1">12000+</div>
                <p className="text-gray-600 text-sm">Customers served</p>
              </div>
              <div>
                <div className="text-4xl font-bold text-red-500 mb-1">75%</div>
                <p className="text-gray-600 text-sm">Customers recommend us</p>
              </div>
              <div>
                <div className="text-4xl font-bold text-red-500 mb-1">50+</div>
                <p className="text-gray-600 text-sm">Cities across India</p>
              </div>
              <div>
                <div className="flex items-center mb-1">
                  <div className="text-4xl font-bold text-red-500">4.6</div>
          ...
          <div className="relative flex items-center justify-center">
            <div className="relative">
              <div className="w-96 h-96 bg-gradient-to-br from-red-400 to-orange-400 rounded-full opacity-20 absolute blur-3xl"></div>
              ...
              <div className="relative z-10 flex flex-col items-center">
                <div className="w-80 h-96 relative">
                  <svg viewBox="0 0 300 400" className="w-full h-full">
                    ...
                    <rect x="100" y="200" width="100" height="150" rx="10" fill="#ef4444"/>
                    ...
                    <text x="150" y="200" fontSize="12" fill="#ef4444" textAnchor="middle" fontWeight="bold">TAX</text>
              ...
              <div className="absolute bottom-8 right-0 bg-red-500 text-white px-6 py-3 rounded-full shadow-lg flex items-center space-x-2 animate-pulse">
      ...
      <div className="absolute top-20 right-10 w-20 h-20 bg-red-200 rounded-full opacity-20 animate-bounce"></div>
      <div className="absolute bottom-20 left-10 w-16 h-16 bg-orange-200 rounded-full opacity-20 animate-bounce delay-100"></div>
    </section>
  );
}
